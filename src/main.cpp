...
// [Name]               [Type]        [Port(s)]
// TOP_RIGHT            motor         1               
// BOTTOM_RIGHT         motor         2               
// FOWARD_RIGHT         motor         3               
// TOP_LEFT             motor         10              
// BOTTOM_LEFT          motor         8               
// FOWARD_LEFT          motor         7               
...
//Left Motors:
motor_group(TOP_LEFT,BOTTOM_LEFT,FOWARD_LEFT),

//Right Motors:
motor_group(TOP_RIGHT,BOTTOM_RIGHT,FOWARD_RIGHT),
...
void usercontrol(void) {
  ...
  while (1) {
    ...
    Brain.Screen.printAt(50,70,"Cata Position: %f",CATA.position(rotationUnits::raw));
